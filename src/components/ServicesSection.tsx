        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-24">
          {services.map((service, index) => (
            <motion.div
              ...
              className="bg-white rounded-2xl p-8 shadow-card hover:shadow-lg transition-all duration-300 cursor-pointer group flex flex-col h-full border border-slate-200 hover:border-brand"
            >
        ...
        <div className="mt-16 pt-16 border-t border-slate-100">
           ...
           <div className="flex flex-wrap justify-center gap-6 md:gap-10 items-center">
              {partners.map((partner, idx) => (
                 <div key={idx} className="text-center px-5 py-3 border border-slate-200 rounded-xl bg-white hover:border-brand hover:shadow-card transition-all">
